<x-admin.layouts.muster>
    <x-slot name="title">Index setting</x-slot>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right text-capitalize">
                                ...
                                <li class="breadcrumb-item active">Index setting</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-8">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Index setting</h3>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 25%">Index status</th>
                                                <th style="width: 25%">index position</th>
                        ...
                        <div class="col-lg-4 col-4">
                            <div class="card card-info">
                                ...
                                <form action="{{ route('admin.setting.index.update') }}" method="post">
                                    @csrf
                                            ...
                                            <div class="row m-0">
                                                <div class="col-6 p-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="status" value="1" {{ isset($update) && $update->index_status == 1? 'checked' : null}}>
                                                        <label class="form-check-label text-capitalize">Activate</label>
                                                    </div>
                                                </div>
                                                <div class="col-6 p-0">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="status" value="0" {{ isset($update) && $update->index_status == 0? 'checked' : null}}>
