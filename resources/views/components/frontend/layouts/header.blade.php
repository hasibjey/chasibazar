...
<section class="relative">
    ...
    <header class=" absolute bg-gradient-to-b from-black/70 top-0 left-1/2 -translate-x-1/2 w-full z-50">
        ...
        <div class="container grid grid-cols-10 items-center py-5">
            ...
            <a href="{{ route('home') }}" class="block col-span-7 lg:col-span-2">
                <h1
                    class="text-2xl uppercase font-bold tracking-wide flex flex-row items-end gap-1 [text-shadow:_0_2px_0_rgb(0_0_0_/_40%)]">
            ...
            <!-- Language button -->
            <div class="flex flex-row gap-2 justify-end col-span-3 lg:col-span-1 relative">
                <button
    ...
    <section class="absolute top-[25%] z-40 left-1/2 -translate-x-1/2 w-full">
        <div class="text-center text-white">
            ...
            <p
                class="hero-title text-5xl md:text-8xl lg:text-9xl font-bold capitalize scale-100 transition-all duration-500 [text-shadow:_0_6px_0_rgb(0_0_0_/_40%)]">
                Supply Chain</p>
        </div>
    </section>
    ...
    <section class="absolute bottom-0 left-0 w-full z-40">
        <div class="grid grid-cols-2 lg:grid-cols-4 text-white items-center border-b-[20px] border-primary counters">
            <div
                class="flex justify-center py-5 lg:py-10 border border-white border-b-0 border-r-0 border-l-0 counters">
                <div class="">
                    <p class="text-3xl lg:text-5xl [text-shadow:_0_6px_0_rgb(0_0_0_/_40%)] font-semibold" data-count="0"
                        data-end="2.4" data-increment="0.5">TK <span class="counter" data-count="0" data-end="2.4"
                            data-increment="0.5">2.45</span>B</p>
            ...
            <div class="flex justify-center py-5 lg:py-10 border border-white border-b-0 border-r-0">
                <div class="">
                    <p class="text-3xl lg:text-5xl [text-shadow:_0_6px_0_rgb(0_0_0_/_40%)] font-semibold"><span
                            class="counter" data-count="0" data-end="113839" data-increment="1000">113839</span>+</p>
                    <p class="text-base md:text-lg [text-shadow:_0_2px_0_rgb(0_0_0_/_40%)]">Registered Farmers
                    </p>
                </div>
            </div>
            <div
                class="flex justify-center py-5 lg:py-10 border border-white border-b-0 border-r-0 border-l-0 lg:border-l">
                <div class="">
                    <p class="text-3xl lg:text-5xl [text-shadow:_0_6px_0_rgb(0_0_0_/_40%)] font-semibold"><span
                            class="counter" data-count="0" data-end="14000" data-increment="100">14000</span>+
                    </p>
            ...
            <div class="flex justify-center py-5 lg:py-10 border border-white border-b-0 border-r-0">
                <div class="">
                    <p class="text-3xl lg:text-5xl [text-shadow:_0_6px_0_rgb(0_0_0_/_40%)] font-semibold"><span
                            class="counter" data-count="0" data-end="299" data-increment="1">299</span>K Ton</p>
